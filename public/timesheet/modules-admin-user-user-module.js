...
var UserCreateComponent = /** @class */ (function () {
    ...
    UserCreateComponent.prototype.changeSalary = function (event) {
        ...
        if (typeof this.createUserForm.value.contract.lunck === 'string') {
            this.createUserForm.value.contract.lunck = this.createUserForm.value.contract.lunck.replace(/,/g, '');
        }
        totalSalary += Number(this.createUserForm.value.contract.lunck);
...
var UserEditComponent = /** @class */ (function () {
    ...
    UserEditComponent.prototype.loadUserForm = function () {
        this.editUserForm = this.formBuilder.group({
            ...
            contract: this.formBuilder.group({
                ...
                lunck: [this.user.contract.lunck],
    ...
    UserEditComponent.prototype.changeSalary = function (event) {
        ...
        if (typeof this.editUserForm.value.contract.lunck === 'string') {
            this.editUserForm.value.contract.lunck = this.editUserForm.value.contract.lunck.replace(/,/g, '');
        }
        totalSalary += Number(this.editUserForm.value.contract.lunck);
