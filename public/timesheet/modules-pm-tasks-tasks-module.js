...
var TaskCreateComponent = /** @class */ (function () {
    function TaskCreateComponent(translate, router, route, formBuilder, toastr, taskService, projectService, customFieldsService, datepipe, authenticationService) {
        var _this = this;
        this.translate = translate;
        this.router = router;
        this.route = route;
    ...
    TaskCreateComponent.prototype.loadForms = function (parentTaskId) {
        if (parentTaskId == 0) {
            this.createTaskForm = this.formBuilder.group({
                ...
                task_end_date: [null],
                assign_to: [null],
                price_rate: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(0.1), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern(/^[0-9]+(\.[0-9]{1,2})?$/)]],
