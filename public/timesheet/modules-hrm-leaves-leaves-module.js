...
var CreateLeaveComponent = /** @class */ (function () {
    ...
    CreateLeaveComponent.prototype.onSubmit = function () {
        ...
        // if(this.createLeaveForm.value.leave_type_id == 3){
        //     let reason = 'Projects: <br>';
        //     for (let index = 0; index < this.createLeaveForm.value.project.length; index++) {
        //         this.createLeaveForm.value.reason += this.createLeaveForm.value.project[index].project_name +'<br>';
        //     }
        //     this.createLeaveForm.value.reason += 'Work Allowance: <br>';
        //     for (let index = 0; index < this.createLeaveForm.value.workAllowance.length; index++) {
        //         this.createLeaveForm.value.reason += this.createLeaveForm.value.workAllowance[index].label +': '+this.createLeaveForm.value.workAllowance[index].value+'<br>';
        //     }
        //     this.createLeaveForm.value.workAllowance.forEach((value, index) => {
        //         this.createLeaveForm.value.reason += value.label +': '+value.value+'<br>';
        //     });
        //     this.createLeaveForm.value.reason = reason;
        // }
