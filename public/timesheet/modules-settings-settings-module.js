...
var SystemSettingsComponent = /** @class */ (function () {
    ...
    SystemSettingsComponent.prototype.loadForm = function () {
        this.settingsForm = this.formBuilder.group({
            ...
            time_days: [this.settings.time_days, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].min(0), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].max(24)]],
            time_hours: [this.settings.time_hours, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
