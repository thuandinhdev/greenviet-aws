...
class TimesheetController extends Controller
{
    ...
    public function getTimesheetsCalendar(Request $request)
    {
        return $this->timesheetRepo->getTimesheetsCalendar($request);
    }
    ...
    public function approvedTimesheet(Request $request)
    {
    ...
    {
        if ($this->timesheetRepo->disapprovedTimesheet($request)) {
            return response()->json('success');
        }
    }
