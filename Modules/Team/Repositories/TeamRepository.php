...
class TeamRepository
{
    ...
    {
        return User::join('gv_user_role_department', 'gv_user_role_department.user_id', '=', 'gv_users.id')->whereIn('gv_user_role_department.department_id', [1,2])->select('gv_users.*')->get();
        return Team::with(
